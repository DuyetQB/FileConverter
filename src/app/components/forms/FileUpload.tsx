            ...
            <div className='flex-1'>
              <div className='flex justify-between items-center '>
                ...
                <div className='flex flex-wrap gap-1'>
                  ...
                  <a href={rc.link} download={rc.fileName} className='text-white bg-primary-600 hover:bg-primary-700 dark:text-white focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-2 lg:px-3  py-2 lg:py-2.5 mr-2 dark:hover:bg-grey focus:outline-none dark:focus:ring-gray-800'
                  >Download</a>
