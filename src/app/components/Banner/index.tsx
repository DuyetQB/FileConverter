        ...
        <div className='relative p-2'>
            <div className='flex flex-wrap'>
                ...
                <div className='pb-2 lg:flex-1'>
                    ...
                    <p className='text-[1.2em] leading-relaxed text-justify lg:text-left mt-5'>FilesConvert is a versatile platform designed to streamline file type conversions. Whether you need to convert documents, images, audio. It's the fastest system convert file compare to other tools. FilesConvert offers a seamless and efficient solution. With an intuitive interface and robust functionality, users can easily transform their files into the desired formats with just a few clicks.</p>
