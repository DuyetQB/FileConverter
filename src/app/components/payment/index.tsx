        ...
        <section className="bg-white">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-black">Best convert files tool for you</h2>
                    <p className="mb-5 font-light sm:text-xl  text-black">We focus on solutions that address the most basic needs. Can bring long-term value and promote economic growth.</p>
                </div>
