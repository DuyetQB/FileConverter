            ...
            <nav className={`bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 ${!isShowNav ? '' : 'fixed left-0 right-0'}`}>
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link href="/" className="flex items-center gap-2">
                        <IconLogo />
                        <span className="self-center text-xl font-semibold whitespace-nowrap">FilesConvert</span>
                    </Link>
                    <div className="flex items-center lg:order-2">
                        <button data-collapse-toggle="mobile-menu-2" type="button"
                            onClick={() => setIsShowNav(!isShowNav)}

                            className="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 " aria-controls="mobile-menu-2" aria-expanded="false">
